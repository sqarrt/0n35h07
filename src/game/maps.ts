...
import os_surf from '../maps/os_surf/raw.json'
...
export const MAPS: Record<MapId, GameMap> = {
  ...
  os_surf: os_surf as unknown as GameMap,
  os_test: os_test as unknown as GameMap,
}

export const MAP_IDS: MapId[] = ['os_arena', 'os_india', 'os_pillars', 'os_pool_day', 'os_surf', 'os_test']
