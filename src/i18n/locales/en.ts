...
export const en = {
  ...
  lobbyMode1v1: '1 VS 1',
  lobbyMode2v2: '2 VS 2',
  lobbyModeFfa: 'FREE FOR ALL',
  lobbyAddBot: 'ADD A BOT',
  lobbyJoinByCode: 'JOIN BY CODE',
  lobbyBot: 'BOT',
  ...
  lobbyWaitOthers: 'WAITING FOR OTHERS…',
  lobbyPickFriend: 'CHOOSE A FRIEND',
  lobbyPickerSearch: 'Search…',
  ...
  radioCtxPlay: 'Play',
  radioCtxNewFolder: 'New folder',
  radioCtxRename: 'Rename',
  radioCtxCopy: 'Copy',
  radioCtxPaste: 'Paste',
