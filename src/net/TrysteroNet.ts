 ...
 * nostr-сигналинг (~860мс) → фриз на «Создать лобби». Поднимаем «warmup»-комнату заранее (в простое меню)
 * и сразу выходим — тяжёлая инициализация проходит в фоне, реальное создание лобби потом мгновенно.
 * Один раз за сессию.
 */
